      ...
      <div className="grid grid-cols-1 md:grid-cols-5 gap-3">
        <div>
          ...
          >
            ...
            <option value="ong_attestation_creation">Création attestation</option>
  ...
  return (
    <div>
      <AuditTableEnrichi
        ...
        titre="Journal d'Audit — ONG"
        sousTitre="Qui a créé quel bénéficiaire, à quelle heure, depuis quel appareil — suivi complet."
        filtres={filtres}
