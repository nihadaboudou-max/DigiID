      ...
      try {
        ...
        if (resPermis.historique.length > 0) {
          ...
          docPermis = {
            ...
            _off_date_premiere_delivrance: p.date_premiere_delivrance,
            _off_date_expiration: p.date_expiration,
            _off_autorite_delivrance: p.autorite_delivrance,
            _off_lieu_delivrance: p.lieu_delivrance,
      ...
      try {
        ...
        if (resAssurance.historique.length > 0) {
          ...
          docAssurance = {
            ...
            source: "ocr",
            a_ete_corrige: false,
            nom_complet: `${a.nom_famille || ""} ${a.prenoms || ""}`.trim(),
            compagnie_assurance: a.compagnie_assurance,
            numero_contrat: a.numero_contrat,
            immatriculation_vehicule: a.immatriculation_vehicule,
            marque_vehicule: a.marque_vehicule,
            modele_vehicule: a.modele_vehicule,
            ...
            _off_marque_vehicule: a.marque_vehicule,
            _off_modele_vehicule: a.modele_vehicule,
            _off_date_effet: a.date_effet,
...
function VueDocument({
  ...
  const champsOfficielsSpecifiques = 
    doc.type_document === "permis" ? [
      ...
      { key: "_off_date_premiere_delivrance", libelle: "Première délivrance", isDate: true },
      ...
      { key: "_off_lieu_delivrance", libelle: "Lieu de délivrance" },
      ...
      { key: "_off_lieu_naissance", libelle: "Lieu de naissance" },
      { key: "_off_date_delivrance", libelle: "Délivré le", isDate: true },
      { key: "_off_date_effet", libelle: "Date d'effet", isDate: true },
      { key: "_off_date_expiration", libelle: "Valable jusqu'au", isDate: true, checkExpiration: true },
      { key: "_off_marque_vehicule", libelle: "Marque (extraite)" },
      { key: "_off_modele_vehicule", libelle: "Modèle (extrait)" },
    ] : [];
