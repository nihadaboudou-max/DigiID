      ...
      <div className="grid grid-cols-1 md:grid-cols-5 gap-3">
        <div>
          ...
          >
            ...
            <option value="police_recherche_personne">Recherche personne</option>
            <option value="police_signalement_fraude">Signalement fraude</option>
            <option value="police_comparaison_photo">Comparaison photo</option>
            <option value="police_scan_qr">Scan QR Code</option>
  ...
  return (
    <div>
      <AuditTableEnrichi
        ...
        titre="Journal d'Audit — Police"
        sousTitre="Qui a fait quoi, à quelle heure, avec quel appareil, depuis où — tout est tracé en temps réel."
        filtres={filtres}
