...
function Contenu() {
  ...
  async function chargerMissions() {
    try {
      ...
      // Filtrer uniquement les missions en cours ou planifiées
      const missionsActives = dataArray.filter((m: any) => 
        m.statut === "en_cours" || m.statut === "planifiee"
      );
      ...
      {afficherFormulaire && (
        <Carte titre="Ajouter un bénéficiaire">
          <div className="max-w-md space-y-3">
            ...
            {/* ✅ Sélection du programme parmi les existants */}
            <div>
            ...
            {/* ✅ Sélection de la mission en cours */}
            <div>
              <label className="block text-xs uppercase text-ardoise-clair font-semibold mb-1">
                Mission (optionnel)
              </label>
              ...
              {missions.length === 0 && (
                <p className="text-xs text-ardoise-clair mt-1 italic">Aucune mission en cours</p>
              )}
            </div>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-ardoise-clair">
                      {b.programme} 
                      {b.mission_titre && ` · 📋 ${b.mission_titre}`}
                      {b.zone && ` · ${b.zone}`}
                    </p>
                  </div>
                </div>
