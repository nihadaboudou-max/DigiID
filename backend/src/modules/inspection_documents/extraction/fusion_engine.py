...
def fusionner_donnees(
    ...
    donnees_finales = DonneesDocumentExtraites(
        ...
        pays_emetteur=donnees_ocr.get("pays_emetteur") or donnees_mrz.get("pays_emetteur_nom"),
        ...
        date_delivrance=donnees_ocr.get("date_delivrance"),
        lieu_naissance=donnees_ocr.get("lieu_naissance"),
        autorite_delivrance=donnees_ocr.get("autorite_delivrance"),
        nationalite=donnees_ocr.get("nationalite") or donnees_ocr.get("pays_emetteur"),
        taille=donnees_ocr.get("taille"),
        format_carte=donnees_ocr.get("format_carte"),
