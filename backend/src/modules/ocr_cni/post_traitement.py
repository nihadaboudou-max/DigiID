...
- Correction orthographique contextuelle (noms, prénoms, villes africaines)
- Normalisation des formats (dates, numéros, MRZ)
- Détection et correction des erreurs OCR courantes
  (confusions : O/0, I/1/l, S/5, B/8, etc.)
- Reconstruction des champs fragmentés
