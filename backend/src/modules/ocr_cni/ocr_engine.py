...
- Prétraitement (redimensionnement, normalisation, débruitage, binarisation)
- OCR avec Tesseract (langue fra + eng)
- Extraction MRZ multi-stratégies (TD1, TD2, TD3)
- Nettoyage et structuration du texte brut
