...
Vérifications multi-niveaux :
  1. Cohérence recto/verso (mêmes informations sur les deux faces)
  2. Cohérence MRZ ↔ OCR texte
  3. Cohérence des dates (naissance < délivrance < expiration)
  4. Cohérence des formats par pays
  5. Vérification du checksum MRZ
  6. Détection d'anomalies (OCR incohérent, dates impossibles)
  7. Score de confiance global basé sur la convergence des sources
