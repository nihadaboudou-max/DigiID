...
- Redimensionnement adaptatif (max 2500px)
- Débruitage (filtre médian + Gaussian blur léger)
- Binarisation adaptative (Otsu + Sauvola selon le document)
- Correction de perspective (détection des 4 coins)
- Redressement de l'inclinaison (deskew)
- Amélioration du contraste (CLAHE)
- Détection et rehaussement de la MRZ
