...
def upgrade() -> None:
    ...
    op.execute(
        ...
        -- AGENT_MEDICAL
        ('agent_medical', 'creation_dossier', 'Création dossier médical', 'Nouveau dossier patient', 'file-plus', true, false),
        ('agent_medical', 'suivi_dossier', 'Suivi des dossiers', 'Consultation et suivi des patients', 'folder', true, false),
        ('agent_medical', 'recherche_patient', 'Recherche patient', 'Recherche par ID DigiID ou CNI', 'search', true, false),
        ('agent_medical', 'attestations_medicales', 'Attestations médicales', 'Émission et gestion d''attestations', 'file-text', true, false),
        ('agent_medical', 'historique_consultations', 'Historique consultations', 'Timeline des consultations', 'clock', true, true),
        ('agent_medical', 'ordonnances', 'Ordonnances', 'Prescriptions et documents', 'file', true, false),
        ('agent_medical', 'calendrier_rendezvous', 'Calendrier rendez-vous', 'Planification des consultations', 'calendar', true, false),
        ('agent_medical', 'mon_profil_agent', 'Mon profil agent', 'Informations professionnelles', 'user', true, true),
        -- AGENT_POLICE
        ('agent_police', 'verification_identite', 'Vérification d''identité', 'Vérification rapide d''une personne', 'search', true, false),
        ('agent_police', 'consultation_score', 'Consultation score', 'Score de confiance du citoyen', 'trending-up', true, true),
        ('agent_police', 'recherche_personne', 'Recherche personne', 'Recherche par empreinte ou identifiant', 'fingerprint', true, false),
        ('agent_police', 'audit_acces_police', 'Audit accès police', 'Historique des vérifications effectuées', 'clock', true, true),
        ('agent_police', 'signalement_fraude', 'Signalement fraude', 'Déclaration d''incidents', 'alert-triangle', true, false),
        ('agent_police', 'mon_profil_agent', 'Mon profil agent', 'Informations professionnelles', 'user', true, true),
        -- AGENT_ONG
        ('agent_ong', 'consultation_beneficiaires', 'Bénéficiaires', 'Liste des bénéficiaires du programme', 'users', true, false),
        ('agent_ong', 'attestations_communautaires', 'Attestations communautaires', 'Émission d''attestations pour bénéficiaires', 'award', true, false),
        ('agent_ong', 'rapports_terrain', 'Rapports terrain', 'Export et analyse des données terrain', 'file-text', true, false),
        ('agent_ong', 'gestion_programme', 'Gestion programme', 'Indicateurs et suivi de programme', 'bar-chart', true, false),
        ('agent_ong', 'mon_profil_agent', 'Mon profil agent', 'Informations de l''organisation', 'user', true, true),
        ('agent_ong', 'statistiques_ong', 'Statistiques ONG', 'Indicateurs de couverture', 'pie-chart', true, true),
        ('agent_ong', 'calendrier_missions', 'Calendrier missions', 'Planification des missions terrain', 'calendar', true, false),
